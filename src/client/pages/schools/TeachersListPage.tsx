...
import { Plus, X, Mail, Loader2, Copy, Check } from 'lucide-react';
...
export default function TeachersListPage() {
  ...
  // Mock School ID - in real app, get from context
  const SCHOOL_ID = '07d56070-0b62-421b-8524-783387b320a3'; // Replace with real ID or logic
  ...
  const handleInvite = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setStatusMessage(data.error || 'Failed to invite teacher');
      }
    } catch (err) {
      setInviteStatus('error');
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-stone-500 mt-1">Manage your school's faculty</p>
        </div>
        <button 
      ...
      >
        ...
        <h2 className="mt-6 text-xl font-semibold text-stone-700">No teachers found</h2>
        <p className="text-stone-500 mb-6 max-w-md mx-auto">
          Start building your team by inviting teachers to your school. They will receive an email with instructions to join.
        </p>
        <button 
          onClick={() => setIsInviteModalOpen(true)}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-stone-800">Invite a Teacher</h2>
